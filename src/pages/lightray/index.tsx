...
import {
    createCreditSafeCompletion,
    type TCreateCreditSafeSearchRequest,
} from '@/queries/credit-safe'
...
const Chat = () => {
    ...
    const { mutate, isLoading } = useMutation({
        mutationKey: [createCreditSafeCompletion.mutationKey],
        ...
        onSuccess: data => {
            if (!chatId) {
                router.push(`/lightray/?chatId=${data.id}`, undefined, { shallow: true })
            }
        },
        onError: () => {
